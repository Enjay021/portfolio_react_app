    ...
    return (
        <footer className="footer--container">
            <div className="footer--link--container">
                <div>
                    <p className="portfolio--logo--logo--title">myPortfolio</p>
                </div>
                ...
                <div className="footer--social--icon">
                    <ul>
                        <li>
                            <a
                                href="https://www.facebook.com/neljayson021/"
                        ...
                        <li>
                            <a
                                href="https://www.instagram.com/neljayson/"
                                className="navbar--content"
                                target="_blank"
                                rel="noreferrer"
                            >
                        ...
                        <li>
                            <a
                                href="https://twitter.com/EnJayAntonio"
                                className="navbar--content"
                                target="_blank"
                                rel="noreferrer"
                            >
                        ...
                        <li>
                            <a
                                href="https://www.linkedin.com/in/neljayson-antonio-b23178246/"
                                className="navbar--content"
                                target="_blank"
                                rel="noreferrer"
                            >
            ...
            <div className="footer--content--container">
                <p className="footer--content">© myPortfolio</p>
                <div className="footer--social--icon">
                    <ul>
                        <li>
                            <Link
